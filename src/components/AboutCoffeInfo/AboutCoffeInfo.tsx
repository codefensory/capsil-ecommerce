    ...
    <div className="flex flex-col items-center w-full bg-white p-16">
      ...
      <div className="relative w-full max-w-[1440px]">
        <div className="flex items-center w-full max-w-7xl mx-auto">
          <div className="flex flex-col flex-1 z-10 max-w-[498px] space-y-4">
            <AboutCoffeItem
              title="Artesania"
          ...
          <div className="flex-1 w-[897px] h-[600px] bg-[url(/about-coffe.png)] bg-no-repeat bg-center bg-contain" />
        </div>
        <img
